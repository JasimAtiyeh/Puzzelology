...
const init = () => (
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const music = new howler__WEBPACK_IMPORTED_MODULE_2__["Howl"]({
    ...
    Object(_src_welcome_screen_banner__WEBPACK_IMPORTED_MODULE_0__["banner"])(titleBanner, imageSelector, puzzle, music);
...
const imageSelection = (titleBanner, imageSelector, puzzle, music) => {
  ...
  while (imageSelection.firstChild) {
    imageSelection.removeChild(imageSelection.firstChild);
  }
  ...
  images.map(imageLink => {
    ...
    image.addEventListener('click', (e) => {
      ...
      Object(_puzzle_canvas_puzzle_canvas__WEBPACK_IMPORTED_MODULE_0__["puzzleCanvas"])(difficulty, e.target.src, music);
    });
...
const Images = {
  image1: 'https://puzzleology.s3.us-east-2.amazonaws.com/111919_Events-900x600.jpg',
...
const banner = (titleBanner, imageSelector, puzzle, music) => {
  ...
  difficultyButtons.forEach(button => button.addEventListener('click', () => (
    Object(_set_difficulty__WEBPACK_IMPORTED_MODULE_0__["setDifficulty"])(button.textContent, titleBanner, imageSelector, puzzle, music)
  )));
};
...
const setDifficulty = (level, titleBanner, imageSelector, puzzle, music) => {
  if (level === 'Easy') {
  ...
  imageSelector.classList.remove('hidden');
  Object(_image_selection_image_selection__WEBPACK_IMPORTED_MODULE_0__["imageSelection"])(titleBanner, imageSelector, puzzle, music);
};
